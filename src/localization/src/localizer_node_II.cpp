...
public:
  ...
  // ======Pass-through filter for scan z=======
    ...
    pass_filter.setFilterLimits(1, 8);
  ...
  // ======Pass-through filter for scan x=======
    ...
    pass_filter.setFilterLimits(-35, 35);
    pass_filter.filter(*filtered_scan_ptr);
  ...
  // ======Pass-through filter for scan y=======
    ...
    pass_filter.setFilterLimits(-25, 25);
    pass_filter.filter(*filtered_scan_ptr);
...
int main(int argc, char* argv[]){
  ros::init(argc, argv, "localizerIII");
  ros::NodeHandle n("~");
